...
db.createCollection("catalog_computing");
db.catalog_computing.insertMany([
    {
        "_id": "81eb9eebb5d941c5a153b7bcbf3f822a",
        "resourceName": "cloudServer",
        "resourceCategory": "computing",
...
db.createCollection("catalog_container");
db.catalog_container.insertMany([
    {
        "_id": "8108329f04a04fb39725607694801461",
        "resourceName": "kaas",
        "resourceCategory": "container",
...
db.createCollection("catalog_networking");
db.catalog_networking.insertMany([
    {
        "_id": "83dcd812afd8462cb3f17ed98decd42f",
        "resourceName": "elasticIp",
        "resourceCategory": "networking",
...
db.createCollection("catalog_storage");
db.catalog_storage.insertMany([
    {
        "_id": "ff615eba519c49ffbbd8a6e91ccd0765",
